...
$switch-size-m-width: $s-12 !default;
/// radius
/// @namespace size/bounding
$switch-size-m-radius-container: $corner-5 !default;
...
/// radius
/// @namespace size/handle
$switch-size-m-radius-trigger: $corner-5 !default;

// Small
// ----------------------------------------
/// width
/// @namespace size/bounding
$switch-size-s-width: $s-9 !default;
/// radius
/// @namespace size/bounding
$switch-size-s-radius-container: $corner-5 !default;
...
/// radius
/// @namespace size/handle
$switch-size-s-radius-trigger: $corner-5 !default;
...
$switch-normal-on-bg-color: $color-success-2 !default;
/// background
/// @level on
/// @state hover
/// @namespace statement/hover/bounding
$switch-hover-on-bg-color: $color-success-3 !default;
/// background
/// @level on
/// @state disabled
/// @namespace statement/disabled/bounding
$switch-disabled-on-bg-color: $color-line1-3 !default;
...
$switch-disabled-on-trigger-bg-color: $color-line1-1 !default;
...
$switch-disabled-on-color-font: $color-line1-2 !default;

/// border color
/// @level on
/// @state disabled
/// @namespace statement/disabled/bounding
$switch-disabled-on-border-color: $color-line1-2 !default;
...
/// @state hover
/// @namespace statement/hover/bounding
$switch-hover-off-bg-color: $color-fill1-1 !default;
/// background
/// @level off
/// @state disabled
/// @namespace statement/disabled/bounding
$switch-disabled-off-bg-color: $color-line1-3 !default;
...
/// @state disabled
/// @namespace statement/disabled/handle
$switch-disabled-off-trigger-bg-color: $color-line1-1 !default;
/// border color
/// @state disabled
/// @namespace statement/disabled/handle
$switch-handle-disabled-border-color: $color-transparent !default;
/// text
/// @level on
/// @namespace statement/normal/content
$switch-normal-off-color-font: $color-text1-1 !default;

/// text
/// @level on
/// @state disabled
/// @namespace statement/hover/content
$switch-disabled-off-color-font: $color-line1-2 !default;
/// border
/// @state disabled
/// @namespace statement/normal/handle
...
/// @level off
/// @namespace statement/normal/bounding
$switch-normal-off-border-color: $color-line1-2 !default;
/// border
/// @level off
/// @state hover
/// @namespace statement/hover/bounding
