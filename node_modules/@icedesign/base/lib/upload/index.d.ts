...
export interface ImageUploadProps extends React.HTMLAttributes<HTMLElement> {}

export class ImageUpload extends React.Component<ImageUploadProps, any> {}

export interface DragUploadProps extends React.HTMLAttributes<HTMLElement> {
  /**
   * 样式前缀
   */
  prefix?: string;
...
export interface CoreProps extends React.HTMLAttributes<HTMLElement> {
  /**
   * 可选参数，自定义样式
   */
  style?: React.CSSProperties;
...
export interface ListProps extends React.HTMLAttributes<HTMLElement> {
   ...
   * 渲染
   */
  cell?: ((value: {}, idx: number) => React.ReactElement<any>);
}
