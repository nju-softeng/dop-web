...
#{$number-picker-prefix} {
    ...
    &-inline {
        ...
        & #{$number-picker-prefix}-input-wrap {
            margin-left: $number-picker-inline-handler-width + $number-picker-inline-input-margin;
            margin-right: $number-picker-inline-handler-width + $number-picker-inline-input-margin;
        }
