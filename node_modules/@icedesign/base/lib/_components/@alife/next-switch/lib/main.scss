...
.#{$css-prefix}switch{
    ...
    .#{$css-prefix}switch-trigger {
        transition: all .4s cubic-bezier(0.78, 0.14, 0.15, 0.86);
    ...
    &-on {
        ...
        > .#{$css-prefix}switch-children{
            left: $switch-text-on-left + $switch-border-width-container * 2 - 2;
    ...
    &-off {
        ...
        > .#{$css-prefix}switch-children{
            right: $switch-text-off-right + $switch-border-width-container * 2 - 2;
